package com.crowdsensing.sensordatacollector.view.allprojects;
...
import com.crowdsensing.sensordatacollector.view.allprojects.AllProjectListFragment.OnListFragmentInteractionListener;
 ...
 */
public class AllProjectsListRecyclerViewAdapter extends RecyclerView.Adapter<AllProjectsListRecyclerViewAdapter.ViewHolder> {

    private final List<Project> mProjectList;
    private final AllProjectListFragment.OnListFragmentInteractionListener mListener;

    public AllProjectsListRecyclerViewAdapter(List<Project> projectList, OnListFragmentInteractionListener listener) {
